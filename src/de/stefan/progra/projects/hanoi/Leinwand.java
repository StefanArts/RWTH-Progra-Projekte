package de.stefan.progra.projects.hanoi;
...
public class Leinwand
{
  ...
  public static Leinwand gibLeinwand()
  {
    ...
    {
      leinwandSingleton =
        new Leinwand("BlueJ Figuren Demo", 800, 600, Color.white);
    }
   ...
   */
  private Leinwand(String titel, int initBreite, int initHoehe, Color grundfarbe)
  {
    fenster = new JFrame();
    zeichenflaeche = new Zeichenflaeche();
    fenster.addComponentListener(new ComponentAdapter() {
      public void componentResized(ComponentEvent e) {
        zeichenflaeche.setSize(new Dimension(e.getComponent().getWidth(), e.getComponent().getHeight()));
      }
    });
    fenster.setContentPane(zeichenflaeche);
    fenster.setTitle(titel);
    zeichenflaeche.setPreferredSize(new Dimension(initBreite, initHoehe));
  ...
  public List gibFiguren() {
    return figuren;
  }

  public Object gibFigur(Object e) {
    if(figuren.contains(e)) {
      for(Object o : figuren) {
        if(o.equals(e)) {
          return e;
        }
      }
